...
REQUIRED_SCHEMAS = {
    ...
    "changed_file_ledger": "stage1.sctsr.changed_file_ledger.v1",
    ...
    "dataset_content_ledger": "stage1.sctsr.dataset_content_ledger.v1",
    "dataset_content_exclusions": "stage1.sctsr.dataset_content_exclusions.v1",
    "deployment_plan": "stage1.sctsr.deployment_plan.v1",
    ...
    "execution_claim_registry": "stage1.sctsr.execution_claim_registry.v2",
    "external_file_binding": "stage1.sctsr.external_file_binding.v1",
    ...
    "formal_execution_claim": "stage1.sctsr.formal_execution_claim.v3",
    "logical_job_control_lock": "stage1.sctsr.logical_job_control_lock.v1",
    "logical_job_fence": "stage1.sctsr.logical_job_fence.v2",
    "logical_job_heartbeat": "stage1.sctsr.logical_job_heartbeat.v2",
    "logical_job_terminal_receipt": "stage1.sctsr.logical_job_terminal_receipt.v1",
    "formal_execution_token": "stage1.sctsr.formal_execution_token.v2",
    "formal_input_snapshot": "stage1.sctsr.formal_input_snapshot.v1",
    ...
    "formal_run_manifest": "stage1.sctsr.formal_run_manifest.v2",
    ...
    "implementation_self_audit": "stage1.sctsr.implementation_self_audit.v1",
    "legacy_evidence_audit": "stage1.sctsr.legacy_evidence_audit.v1",
    "logical_artifact_index": "stage1.sctsr.logical_artifact_index.v1",
    "manual_line_review": "stage1.sctsr.manual_line_review.v1",
    ...
    "run_intent_acknowledgement": "stage1.sctsr.run_intent_acknowledgement.v1",
    "run_intent_binding": "stage1.sctsr.run_intent_binding.v1",
    "run_intent_snapshot": "stage1.sctsr.run_intent_snapshot.v1",
    "runbook_manifest": "stage1.sctsr.runbook_manifest.v1",
    "schedule": "stage1.sctsr.schedule.v1",
    "schema_registry": "stage1.sctsr.schema_registry.v1",
    "self_audit_input_plan": "stage1.sctsr.self_audit_input_plan.v1",
